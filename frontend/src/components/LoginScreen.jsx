    ...
    <div style={{ position: 'absolute', inset: 0, zIndex: 0, pointerEvents: 'none' }}>
      <img
        ...
        style={{
          ...
          opacity: 0.95, filter: 'saturate(1.15) contrast(1.15) brightness(0.7)'
        }}
      />
      {/* Dark vignette to focus center */}
      <div style={{ position: 'absolute', inset: 0, background: 'radial-gradient(ellipse at center, transparent 20%, rgba(4,9,4,0.85) 100%)' }} />
    </div>
  )
}
...
function JungleCanopy() {
  return (
    <div style={{ position: 'absolute', top: 0, left: 0, right: 0, height: '20vh', zIndex: 7, pointerEvents: 'none', overflow: 'hidden', filter: 'drop-shadow(0 20px 30px rgba(0,0,0,0.85))' }}>
...
function GroundRoots() {
  return (
    <div style={{ position: 'absolute', bottom: 0, left: 0, right: 0, height: '32vh', zIndex: 7, pointerEvents: 'none', filter: 'drop-shadow(0 -20px 30px rgba(0,0,0,0.85))' }}>
    ...
    <div style={{ position: 'absolute', inset: 0, zIndex: 2, pointerEvents: 'none', overflow: 'hidden' }}>
      {rays.map((r, i) => (
        <motion.div
          ...
          style={{
            position: 'absolute', top: 0, left: r.left, width: 60, height: '90vh',
            background: `linear-gradient(180deg, rgba(160,250,100,${r.op * 3}) 0%, rgba(200,220,50,${r.op * 1.5}) 40%, transparent 100%)`,
      ...
      {flies.map(f => (
        <motion.div
          ...
          style={{
            ...
            background: f.isGreen ? 'rgba(100,255,80,1)' : 'rgba(255,200,80,1)',
            boxShadow: f.isGreen ? '0 0 12px 3px rgba(55,255,40,0.8)' : '0 0 12px 3px rgba(255,200,30,0.8)',
      ...
      <div style={{
        ...
        <motion.div
          ...
          style={{
            ...
            background: `
              linear-gradient(160deg, rgba(10,20,8,0.75) 0%, rgba(6,14,4,0.85) 100%)
            `,
            borderRadius: 20,
            border: '1px solid rgba(80,200,40,0.25)',
            boxShadow: `
              0 0 0 1px rgba(40,120,15,0.1),
              0 30px 60px rgba(0,0,0,0.9),
              0 0 50px rgba(40,150,15,0.15),
              inset 0 1px 0 rgba(100,250,50,0.15)
            `,
